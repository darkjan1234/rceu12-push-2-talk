...
.method public static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    .line 24
    invoke-static {v1}, Landroidx/compose/ui/text/input/b;->h(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getLocusId(Landroid/content/pm/ShortcutInfo;)Landroidx/core/content/LocusIdCompat;
    ...
    .line 2
    invoke-static {p0}, Landroidx/compose/ui/text/android/b;->a(Landroid/content/pm/ShortcutInfo;)Landroid/content/LocusId;
    ...
    .line 4
    :cond_1
    invoke-static {p0}, Landroidx/compose/ui/text/input/b;->i(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    .line 1
    invoke-static {}, Landroidx/compose/ui/text/input/b;->n()V
    ...
    .line 7
    .line 8
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 13
    .line 14
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->e(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 19
    .line 20
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->f(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 34
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->q(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)V
    ...
    .line 46
    .line 47
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->s(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)V
    ...
    .line 59
    .line 60
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->z(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)V
    ...
    .line 66
    .line 67
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->p(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)V
    ...
    .line 73
    .line 74
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->t(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)V
    ...
    .line 78
    .line 79
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->o(Landroid/content/pm/ShortcutInfo$Builder;I)V
    ...
    .line 85
    .line 86
    invoke-static {v0, v1}, Landroidx/compose/ui/text/input/b;->r(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)V
    ...
    .line 121
    :cond_6
    invoke-static {v0, v2}, Landroidx/compose/ui/text/android/b;->k(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)V
    ...
    .line 132
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/b;->i(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)V
    ...
    .line 136
    .line 137
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/b;->j(Landroid/content/pm/ShortcutInfo$Builder;Z)V
    ...
    .line 159
    :cond_a
    invoke-static {v0}, Landroidx/compose/ui/text/input/b;->g(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
